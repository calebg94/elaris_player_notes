...
At the start of each of your turns, you regain [Hit Points](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md) equal to 5 plus your Constitution modifier if you are [Bloodied](3-Mechanics/CLI/rules/variant-rules/bloodied-xphb.md) and have at least 1 [Hit Point](3-Mechanics/CLI/rules/variant-rules/hit-points-xphb.md).